...
const data: [string, string, number, string, number, number, number, number, number, number, number, number][] = [
    ...
    // like 礼 in lieu of 礻
    ['扌', '⿰',   0, '把', 2,   1, 0.33,   0,  0.73,   0,1.75,  1.1],
    ...
    ['米', '⿰',   0, '粑', 2.5,   1,0.25,   0, 0.68, 0.0,1.25,  1.1],
    ...
    ['彳', '⿲',   0,  '' , 1.5,   1,   0,   0,    0,   0,   0,    0],
    ['米', '⿲',   1, '粑', 2.5,   1,0.25,   0, 0.68, 0.0,1.25,  1.1],
    ...
    ['气', '⿹',   0, '氤',   1,   1,   0,   0, 0.13,0.38,0.71, 1.0],
