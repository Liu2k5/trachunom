...
async function findByStructureId_1(structureId: number | undefined, init?: EndpointRequestInit_1): Promise<Array<StructureComponent_1 | undefined> | undefined> { return client_1.call("StructureComponentService", "findByStructureId", { structureId }, init); }
...
export { count_1 as count, deleteById_1 as deleteById, deleteByStructure_1 as deleteByStructure, exists_1 as exists, findAll_1 as findAll, findById_1 as findById, findByStructureId_1 as findByStructureId, get_1 as get, getStructureComponents_1 as getStructureComponents, list_1 as list, save_1 as save };
