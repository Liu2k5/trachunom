...
async function save_1(structureComponent: StructureComponent_1 | undefined, init?: EndpointRequestInit_1): Promise<void> { return client_1.call("StructureComponentService", "save", { structureComponent }, init); }
