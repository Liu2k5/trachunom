...
const routes: readonly AgnosticRoute_1[] = [
    ...
    createRoute_1("DictionaryManagementView", lazy_1(() => import("../views/DictionaryManagementView.js")), { "route": "/admin/dictionary-management", "menu": { "order": 2, "icon": "la la-book" }, "title": "Qu\u1EA3n L\u00FD T\u1EEB \u0110i\u1EC3n", "flowLayout": false }),
