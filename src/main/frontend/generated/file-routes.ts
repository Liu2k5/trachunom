...
const routes: readonly AgnosticRoute_1[] = [
    createRoute_1("AboutView", lazy_1(() => import("../views/AboutView.js")), { "route": "about", "menu": { "order": 3, "icon": "la la-info-circle" }, "title": "Gi\u1EDBi Thi\u1EC7u", "flowLayout": false }),
    createRoute_1("DictionaryManagementView", lazy_1(() => import("../views/DictionaryManagementView.js")), { "route": "dictionary-management", "menu": { "order": 2, "icon": "la la-book" }, "title": "Qu\u1EA3n L\u00FD T\u1EEB \u0110i\u1EC3n", "loginRequired": true, "flowLayout": false }),
