...
async function getAllVariantStructuresByStructureId_1(structureId: number | undefined, init?: EndpointRequestInit_1): Promise<Array<Structure_1 | undefined> | undefined> { return client_1.call("StructureService", "getAllVariantStructuresByStructureId", { structureId }, init); }
...
async function getIds_1(id: number | undefined, init?: EndpointRequestInit_1): Promise<string | undefined> { return client_1.call("StructureService", "getIds", { id }, init); }
async function getStructureSequence_1(id: number | undefined, init?: EndpointRequestInit_1): Promise<string | undefined> { return client_1.call("StructureService", "getStructureSequence", { id }, init); }
...
export { count_1 as count, deleteById_1 as deleteById, exists_1 as exists, existsById_1 as existsById, findAll_1 as findAll, findById_1 as findById, get_1 as get, getAllVariantStructuresByStructureId_1 as getAllVariantStructuresByStructureId, getCharacterStringById_1 as getCharacterStringById, getIds_1 as getIds, getStructureSequence_1 as getStructureSequence, list_1 as list, save_1 as save };
