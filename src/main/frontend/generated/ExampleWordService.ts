...
async function findByEntityId_1(entityId: number | undefined, init?: EndpointRequestInit_1): Promise<Array<ExampleWord_1 | undefined> | undefined> { return client_1.call("ExampleWordService", "findByEntityId", { entityId }, init); }
...
export { count_1 as count, deleteById_1 as deleteById, exists_1 as exists, findAll_1 as findAll, findByEntityId_1 as findByEntityId, findByExampleId_1 as findByExampleId, findByExampleIdOrderByPosition_1 as findByExampleIdOrderByPosition, findById_1 as findById, get_1 as get, list_1 as list, save_1 as save };
