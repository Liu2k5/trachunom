...
async function findVariances_1(entity: EntityX_1 | undefined, init?: EndpointRequestInit_1): Promise<Array<EntityX_1 | undefined> | undefined> { return client_1.call("EntityService", "findVariances", { entity }, init); }
...
export { count_1 as count, deleteById_1 as deleteById, exists_1 as exists, existsById_1 as existsById, findAll_1 as findAll, findByCharacter_1 as findByCharacter, findByCompound_1 as findByCompound, findById_1 as findById, findByPronunciation_1 as findByPronunciation, findByPronunciationId_1 as findByPronunciationId, findByQuery_1 as findByQuery, findByStructure_1 as findByStructure, findStandardByEntity_1 as findStandardByEntity, findSynonyms_1 as findSynonyms, findVariances_1 as findVariances, get_1 as get, getHnomStringById_1 as getHnomStringById, getQnguStringById_1 as getQnguStringById, list_1 as list, save_1 as save };
