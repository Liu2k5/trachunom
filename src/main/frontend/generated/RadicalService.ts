...
async function existsByUnicode_1(unicode: number, init?: EndpointRequestInit_1): Promise<boolean> { return client_1.call("RadicalService", "existsByUnicode", { unicode }, init); }
...
export { count_1 as count, delete_1 as delete, deleteById_1 as deleteById, exists_1 as exists, existsById_1 as existsById, existsByUnicode_1 as existsByUnicode, findAll_1 as findAll, findById_1 as findById, findByUnicode_1 as findByUnicode, get_1 as get, list_1 as list, save_1 as save };
