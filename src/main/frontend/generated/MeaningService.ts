...
async function findByPronunciationId_1(id: number | undefined, init?: EndpointRequestInit_1): Promise<Array<Meaning_1 | undefined> | undefined> { return client_1.call("MeaningService", "findByPronunciationId", { id }, init); }
...
export { count_1 as count, deleteById_1 as deleteById, exists_1 as exists, findAll_1 as findAll, findAllWithPronunciation_1 as findAllWithPronunciation, findById_1 as findById, findByPronunciationId_1 as findByPronunciationId, get_1 as get, list_1 as list, save_1 as save };
