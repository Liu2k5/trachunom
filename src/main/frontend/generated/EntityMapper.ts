...
async function getNewStructureDescriptionDto_1(init?: EndpointRequestInit_1): Promise<StructureDescriptionDto_1 | undefined> { return client_1.call("EntityMapper", "getNewStructureDescriptionDto", {}, init); }
async function getNewStructureDescriptionDtoWithStructureId_1(structureId: number | undefined, init?: EndpointRequestInit_1): Promise<StructureDescriptionDto_1 | undefined> { return client_1.call("EntityMapper", "getNewStructureDescriptionDtoWithStructureId", { structureId }, init); }
...
async function toEntityCompositionList_1(compositionDtos: Array<EntityCompositionDto_1 | undefined> | undefined, init?: EndpointRequestInit_1): Promise<Array<EntityComposition_1 | undefined> | undefined> { return client_1.call("EntityMapper", "toEntityCompositionList", { compositionDtos }, init); }
...
async function toEntityEvolutionList_1(evolutionDtos: Array<EntityEvolutionDto_1 | undefined> | undefined, init?: EndpointRequestInit_1): Promise<Array<EntityEvolution_1 | undefined> | undefined> { return client_1.call("EntityMapper", "toEntityEvolutionList", { evolutionDtos }, init); }
...
async function toExampleWordDtoList_1(exampleWords: Array<ExampleWord_1 | undefined> | undefined, init?: EndpointRequestInit_1): Promise<Array<ExampleWordDto_1 | undefined> | undefined> { return client_1.call("EntityMapper", "toExampleWordDtoList", { exampleWords }, init); }
...
async function toMeaningExplanationDtoList_1(meaningExplanations: Array<MeaningExplanation_1 | undefined> | undefined, init?: EndpointRequestInit_1): Promise<Array<MeaningExplanationDto_1 | undefined> | undefined> { return client_1.call("EntityMapper", "toMeaningExplanationDtoList", { meaningExplanations }, init); }
...
async function toPronunciationDtoList_1(pronunciations: Array<Pronunciation_1 | undefined> | undefined, init?: EndpointRequestInit_1): Promise<Array<PronunciationDto_1 | undefined> | undefined> { return client_1.call("EntityMapper", "toPronunciationDtoList", { pronunciations }, init); }
...
async function toPronunciationEvolutionDtoList_1(pronunciationEvolutions: Array<PronunciationEvolution_1 | undefined> | undefined, init?: EndpointRequestInit_1): Promise<Array<PronunciationEvolutionDto_1 | undefined> | undefined> { return client_1.call("EntityMapper", "toPronunciationEvolutionDtoList", { pronunciationEvolutions }, init); }
...
async function toStructureDescription_1(structureDescriptionDto: StructureDescriptionDto_1 | undefined, init?: EndpointRequestInit_1): Promise<StructureDescription_1 | undefined> { return client_1.call("EntityMapper", "toStructureDescription", { structureDescriptionDto }, init); }
async function toStructureDescriptionDto_1(structureDescription: StructureDescription_1 | undefined, init?: EndpointRequestInit_1): Promise<StructureDescriptionDto_1 | undefined> { return client_1.call("EntityMapper", "toStructureDescriptionDto", { structureDescription }, init); }
async function toStructureDescriptionDtoList_1(structureDescriptions: Array<StructureDescription_1 | undefined> | undefined, init?: EndpointRequestInit_1): Promise<Array<StructureDescriptionDto_1 | undefined> | undefined> { return client_1.call("EntityMapper", "toStructureDescriptionDtoList", { structureDescriptions }, init); }
...
export { getNewStructureComponentDto_1 as getNewStructureComponentDto, getNewStructureComponentDtoWithStructureId_1 as getNewStructureComponentDtoWithStructureId, getNewStructureDescriptionDto_1 as getNewStructureDescriptionDto, getNewStructureDescriptionDtoWithStructureId_1 as getNewStructureDescriptionDtoWithStructureId, toCharacter_1 as toCharacter, toCharacterDto_1 as toCharacterDto, toCharacterDtoList_1 as toCharacterDtoList, toDto_1 as toDto, toEntityComposition_1 as toEntityComposition, toEntityCompositionDto_1 as toEntityCompositionDto, toEntityCompositionList_1 as toEntityCompositionList, toEntityDto_1 as toEntityDto, toEntityDtoList_1 as toEntityDtoList, toEntityEvolution_1 as toEntityEvolution, toEntityEvolutionDto_1 as toEntityEvolutionDto, toEntityEvolutionList_1 as toEntityEvolutionList, toEntityX_1 as toEntityX, toExample_1 as toExample, toExampleDto_1 as toExampleDto, toExampleWord_1 as toExampleWord, toExampleWordDto_1 as toExampleWordDto, toExampleWordDtoList_1 as toExampleWordDtoList, toExplanation_1 as toExplanation, toExplanationDto_1 as toExplanationDto, toLanguage_1 as toLanguage, toLanguageDto_1 as toLanguageDto, toMeaning_1 as toMeaning, toMeaningDto_1 as toMeaningDto, toMeaningExplanation_1 as toMeaningExplanation, toMeaningExplanationDto_1 as toMeaningExplanationDto, toMeaningExplanationDtoList_1 as toMeaningExplanationDtoList, toPronunciation_1 as toPronunciation, toPronunciationDto_1 as toPronunciationDto, toPronunciationDtoList_1 as toPronunciationDtoList, toPronunciationEvolution_1 as toPronunciationEvolution, toPronunciationEvolutionDto_1 as toPronunciationEvolutionDto, toPronunciationEvolutionDtoList_1 as toPronunciationEvolutionDtoList, toQuocNgu_1 as toQuocNgu, toQuocNguDto_1 as toQuocNguDto, toRadical_1 as toRadical, toRadicalDto_1 as toRadicalDto, toRadicalDtoList_1 as toRadicalDtoList, toSource_1 as toSource, toSourceDto_1 as toSourceDto, toStructure_1 as toStructure, toStructureClassificationDto_1 as toStructureClassificationDto, toStructureClassificationDtoList_1 as toStructureClassificationDtoList, toStructureComponent_1 as toStructureComponent, toStructureComponentDto_1 as toStructureComponentDto, toStructureComponentDtoList_1 as toStructureComponentDtoList, toStructureDescription_1 as toStructureDescription, toStructureDescriptionDto_1 as toStructureDescriptionDto, toStructureDescriptionDtoList_1 as toStructureDescriptionDtoList, toStructureDto_1 as toStructureDto, toStructureDtoList_1 as toStructureDtoList, toStyle_1 as toStyle, toStyleDto_1 as toStyleDto, toTradSimpStandard_1 as toTradSimpStandard, toTradSimpStandardDto_1 as toTradSimpStandardDto };
