...
async function getHnomByExample_1(example: Example_1 | undefined, init?: EndpointRequestInit_1): Promise<string | undefined> { return client_1.call("ExampleService", "getHnomByExample", { example }, init); }
async function getHnomString_1(example: Example_1 | undefined, init?: EndpointRequestInit_1): Promise<string | undefined> { return client_1.call("ExampleService", "getHnomString", { example }, init); }
async function getQnguByExample_1(example: Example_1 | undefined, init?: EndpointRequestInit_1): Promise<string | undefined> { return client_1.call("ExampleService", "getQnguByExample", { example }, init); }
async function getQnguString_1(example: Example_1 | undefined, init?: EndpointRequestInit_1): Promise<string | undefined> { return client_1.call("ExampleService", "getQnguString", { example }, init); }
...
export { count_1 as count, deleteById_1 as deleteById, exists_1 as exists, findAll_1 as findAll, findByEntityId_1 as findByEntityId, findById_1 as findById, get_1 as get, getHnomByExample_1 as getHnomByExample, getHnomString_1 as getHnomString, getQnguByExample_1 as getQnguByExample, getQnguString_1 as getQnguString, list_1 as list, save_1 as save };
