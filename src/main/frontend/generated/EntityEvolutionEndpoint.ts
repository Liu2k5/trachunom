...
async function saveByIds_1(fromEntityId: number | undefined, toEntityId: number | undefined, description: string | undefined, init?: EndpointRequestInit_1): Promise<EntityEvolutionDto_1 | undefined> { return client_1.call("EntityEvolutionEndpoint", "saveByIds", { fromEntityId, toEntityId, description }, init); }
