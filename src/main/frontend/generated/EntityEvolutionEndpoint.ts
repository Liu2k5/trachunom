...
async function deleteByEachId_1(fromEntityId: number | undefined, toEntityId: number | undefined, descriptionId: number | undefined, init?: EndpointRequestInit_1): Promise<void> { return client_1.call("EntityEvolutionEndpoint", "deleteByEachId", { fromEntityId, toEntityId, descriptionId }, init); }
...
async function saveByIds_1(fromEntityId: number | undefined, toEntityId: number | undefined, descriptionId: number | undefined, init?: EndpointRequestInit_1): Promise<EntityEvolutionDto_1 | undefined> { return client_1.call("EntityEvolutionEndpoint", "saveByIds", { fromEntityId, toEntityId, descriptionId }, init); }
export { delete_1 as delete, deleteByEachId_1 as deleteByEachId, findByFromEntityId_1 as findByFromEntityId, save_1 as save, saveByIds_1 as saveByIds };
