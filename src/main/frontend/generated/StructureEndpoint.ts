...
export { delete_1 as delete, findAll_1 as findAll, getStructureById_1 as getStructureById, getStructureComponents_1 as getStructureComponents, save_1 as save };
