...
import type QuocNgu_1 from "./QuocNgu.js";
class QuocNguModel<T extends QuocNgu_1 = QuocNgu_1> extends ObjectModel_1<T> {
    static override createEmptyValue = makeObjectEmptyValueCreator_1(QuocNguModel);
