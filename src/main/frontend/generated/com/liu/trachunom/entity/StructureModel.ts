...
class StructureModel<T extends Structure_1 = Structure_1> extends ObjectModel_1<T> {
    static override createEmptyValue = makeObjectEmptyValueCreator_1(StructureModel);
    ...
    get character(): CharacterXModel_1 {
        return this[_getPropertyModel_1]("character", (parent, key) => new CharacterXModel_1(parent, key, true, { meta: { annotations: [{ name: "jakarta.persistence.ManyToOne" }] } }));
    }
