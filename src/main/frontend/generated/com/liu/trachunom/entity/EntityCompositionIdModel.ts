...
class EntityCompositionIdModel<T extends EntityCompositionId_1 = EntityCompositionId_1> extends ObjectModel_1<T> {
    static override createEmptyValue = makeObjectEmptyValueCreator_1(EntityCompositionIdModel);
...
export default EntityCompositionIdModel;
