...
import type Source_1 from "./Source.js";
class SourceModel<T extends Source_1 = Source_1> extends ObjectModel_1<T> {
    static override createEmptyValue = makeObjectEmptyValueCreator_1(SourceModel);
