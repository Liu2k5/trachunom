...
class StructureClassificationModel<T extends StructureClassification_1 = StructureClassification_1> extends ObjectModel_1<T> {
    static override createEmptyValue = makeObjectEmptyValueCreator_1(StructureClassificationModel);
...
export default StructureClassificationModel;
