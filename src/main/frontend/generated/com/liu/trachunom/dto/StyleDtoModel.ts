...
import type StyleDto_1 from "./StyleDto.js";
class StyleDtoModel<T extends StyleDto_1 = StyleDto_1> extends ObjectModel_1<T> {
    static override createEmptyValue = makeObjectEmptyValueCreator_1(StyleDtoModel);
