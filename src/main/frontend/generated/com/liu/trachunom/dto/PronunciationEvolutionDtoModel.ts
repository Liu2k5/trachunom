...
class PronunciationEvolutionDtoModel<T extends PronunciationEvolutionDto_1 = PronunciationEvolutionDto_1> extends ObjectModel_1<T> {
    ...
    get fromPronunciationString(): StringModel_1 {
        return this[_getPropertyModel_1]("fromPronunciationString", (parent, key) => new StringModel_1(parent, key, true, { meta: { javaType: "java.lang.String" } }));
    }
    get toPronunciationString(): StringModel_1 {
        return this[_getPropertyModel_1]("toPronunciationString", (parent, key) => new StringModel_1(parent, key, true, { meta: { javaType: "java.lang.String" } }));
    }
}
